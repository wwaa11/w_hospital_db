            ...
            <div class="w-full max-w-4xl">
                <div class="rounded-lg bg-white shadow-sm">
                    ...
                    <div class="p-6">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full border border-gray-200">
                                    <thead>
                                        ...
                                        <tr class="bg-gray-50">
                                            <th class="border px-4 py-2 text-center text-sm font-semibold text-gray-700">Type</th>
                                            <th class="border px-4 py-2 text-center text-sm font-semibold text-gray-700">Supplier</th>
                                            <th class="border px-4 py-2 text-center text-sm font-semibold text-gray-700">Nationality</th>
                                            ...
                                            <th class="border px-4 py-2 text-center text-sm font-semibold text-gray-700">Price</th>
                                            <th class="border px-4 py-2 text-center text-sm font-semibold text-gray-700">UOM</th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        <tr>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">MedicalSupplies3</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Alfatech</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">THAI</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">EQ2</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Coblator Alfatech หัว Tonsil Adenoid</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">อุปกรณ์พิเศษ</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">23125</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">UNIT</td>
                                        </tr>
                                        <tr>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">MedicalSupplies3</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Alfatech</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">INTER</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">EQ2</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Coblator Alfatech หัว Tonsil Adenoid</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">อุปกรณ์พิเศษ</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">30225</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">UNIT</td>
                                        </tr>
                                        <tr>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">MedicalSupplies3</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Alfatech</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">ARAB</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">EQ2</td>
                                            <td class="border-b px-4 py-2 text-sm text-gray-700">Coblator Alfatech หัว Tonsil Adenoid</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">อุปกรณ์พิเศษ</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">36750</td>
                                            <td class="border-b px-4 py-2 text-center text-sm text-gray-700">UNIT</td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <form class="needs-validation" method="POST" action="{{ env("APP_URL") }}/k2/equipment" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="mb-6">
